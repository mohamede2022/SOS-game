...
class GeneralGame(SOSGame):
    ...
    def get_winner(self):
        ...
        if blue_score > red_score:
            return self.blue_player.color, f"Blue: ", self.blue_player.score, f"Red: ", self.red_player.score
        elif red_score > blue_score:
            return self.red_player.color, f"Red: ", self.red_player.score,f"Blue: ", self.blue_player.score
        else:
            return "Draw"
